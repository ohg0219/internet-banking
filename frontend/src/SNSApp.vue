            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        ...
                        to="/customerManagements/customerAccounts"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="bankAccounts"
                        to="/accountManagements/bankAccounts"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: 'Manage customer account information and authentication', 
                key: 'customerAccounts', 
                route: '/customerManagements/customerAccounts',
                ImageUrl: '',
            },
            { 
                title: 'Bank Account', 
                description: 'Manage bank account transactions and balances', 
                key: 'bankAccounts', 
                route: '/accountManagements/bankAccounts',
                ImageUrl: '',
            },
